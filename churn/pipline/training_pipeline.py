...
from churn.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig
...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            data_ingestor = DataIngestion(self.data_ingestion_config)
